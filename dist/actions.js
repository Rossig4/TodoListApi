...
exports.getTodo = exports.getUsers = exports.createUser = void 0;
var typeorm_1 = require("typeorm"); // getRepository"  traer una tabla de la base de datos asociada al objeto
var utils_1 = require("./utils");
var Todo_1 = require("./entities/Todo");
var createUser = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var userRepo, user, newtodoDefault, newUser, results, newtodo;
...
var getUsers = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, typeorm_1.getRepository(User).find({ relations: ["todos"] })];
            case 1:
                users = _a.sent();
...
var getTodo = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var userActual, todos;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, typeorm_1.getRepository(User).find({ where: { id: req.params.id } })];
            case 1:
                userActual = _a.sent();
                return [4 /*yield*/, typeorm_1.getRepository(Todo_1.Todo).find({ relations: ["user"] })];
            case 2:
                todos = _a.sent();
                console.log(todos);
